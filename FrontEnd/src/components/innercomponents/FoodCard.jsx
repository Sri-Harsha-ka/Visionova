...
const FoodCard = ({food}) => {
  return (
    <div className='p-12 w-72 h-96 rounded-xl overflow-hidden bg-[#4A5A48] '>
      <div className=''>
        ...
        <button className='bg-[#DAA520] pl-4 px-5 py-2 rounded-lg w-44 font-semibold text-[#E3DAC9] tracking-wide'>Add to Cart</button>
      </div>
    </div>
  )
}
